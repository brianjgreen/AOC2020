...
int
get_happiness(char *person_a, char *person_b)
{
...
void
add_happiness(char *person, char *sitting, int happy)
{
	add_person(person);
...
void
print_list_of_guests(char **strings, int count)
{
...
void
calc_happiness(char **table_map, int count)
{
	int		total_happiness = 0;
