 ...
 * letters; abd doesn't count. 2.) Passwords may not contain the letters i,
 * o, or l, as these letters can be mistaken for other characters and are
 * therefore confusing. 3.) Passwords must contain at least two different,
...
bool
has_straight_of_three(char *password)
{
	char		triple[] = "abc";
	char	       *ptr = alpha + 2;
...
void
find_valid_password(char **password)
{
	bool		is_valid = false;
