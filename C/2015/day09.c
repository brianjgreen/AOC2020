...
void
add_map(char *point_a, char *point_b, int distance)
{
...
int
get_distance(char *point_a, char *point_b)
{
...
void
print_list(char **strings, int count)
{
...
void
calc_distance(char **dest_map, int count)
{
