...
typedef enum operations {
	NONE, MOV, AND, OR, LSHIFT, RSHIFT, NOT
}		ops;
...
unsigned short
get_wire_value(bool is_part2, wire_t * wire)
{
...
void
update_wire(wire_t * wire, ops op, char *input_a, char *input_b)
{
	wire->op = op;
