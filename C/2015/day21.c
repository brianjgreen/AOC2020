...
int day21()
{
    ...
    if (fileContents)
    {
        ...
        for (size_t r1 = 0; r1 < MAX_RINGS; r1++)
        {
            ...
            {
                if (!(rings[r1].cost == 0 && rings[r2].cost == 0) && (rings[r1].cost == rings[r2].cost))
                {
                    continue;
                }
                for (size_t w = 0; w < MAX_WEAPONS; w++)
                {
                    ...
                    {
                        bool player_won =
                            player_wins(boss_hp, boss_def, boss_att, rings[r1].armor + rings[r2].armor + armor[a].armor,
                                        rings[r1].damage + rings[r2].damage + weapons[w].damage);
                        int cost = rings[r1].cost + rings[r2].cost + armor[a].cost + weapons[w].cost;
