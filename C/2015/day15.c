...
void add_ingredient(char *name, int capacity, int durability, int flavor, int texture, int calories)
{
...
int day15()
{
    ...
    if (fileContents)
    {
        ...
        while (token != NULL)
        {
            ...
            {
                add_ingredient(name, capacity, durability, flavor, texture, calories);
            }
